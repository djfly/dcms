...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns' => array(
		...
		array(
			'name' => 'bizrule',
			'header' => Yii::t('AuthModule.main', 'bizrule'),
			'htmlOptions' => array('class'=>'item-bizrule-column'),
		),
		array(
			'name' => 'data',
			'header' => Yii::t('AuthModule.main', 'data'),
			'htmlOptions' => array('class'=>'item-data-column'),
		),
		array(
