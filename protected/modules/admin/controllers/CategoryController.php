...
class CategoryController extends Controller
{
	...
	*/
	...
	public $menu = array(
    	array('label'=>'分类管理', 'icon'=>'sitemap', 'url'=>array('/admin/category/index')),
    	array('label'=>'创建分类', 'icon'=>'plus', 'url'=>array('/admin/category/create')),
	);
	/**
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','move'),
				'users'=>array('@'),
			),
